...
export async function generateMetadata({
  ...
  const plain = (allMessages as any)?.default ? (allMessages as any).default : allMessages;
  ...
  return {
    ...
    openGraph: {
      url: canonical,
      title: ((): string => { try { return t("ogTitle"); } catch { return t("title"); } })(),
      description: ((): string => { try { return t("ogDescription"); } catch { return t("description"); } })(),
      images: [ogImage],
      siteName: ((): string => { try { return t("siteName"); } catch { return "Foundi"; } })(),
      locale: currentLocale,
      type: "website",
    },
    twitter: {
      card: "summary_large_image",
      title: ((): string => { try { return t("twitterTitle"); } catch { return t("title"); } })(),
      description: ((): string => { try { return t("twitterDescription"); } catch { return t("description"); } })(),
      images: [ogImage],
    },
    authors: ((): { name: string }[] | undefined => {
      try { const a = t("author"); return a ? [{ name: a }] : undefined; } catch { return undefined; }
    })(),
    publisher: ((): string | undefined => { try { return t("publisher"); } catch { return undefined; } })(),
  };
}
